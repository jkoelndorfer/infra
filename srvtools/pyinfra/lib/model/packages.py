...
class PackageSet:
    ...
    def add_debian_package(self, package_debian_name: str) -> None:
        """
        Adds a Debian package to this package set.

        `package_debian_name` should be the name of the package as
        defined in Debian repositories.
        """
        self.debian_packages.append(package_debian_name)

    def add_arch_package(self, package_arch_name: str) -> None:
        """
        Adds an Arch Linux package to this package set.

        `package_arch_name` should be the name of the package as
        defined in Arch repositories.
        """
        self.arch_packages.append(package_arch_name)
