locals {
  ...
  # Domain that hosts my personal website and can receive email categorized by recipient.
  personal_domain = "john.${local.google_organization.domain}"
  ...
  globals = {
    ...
    paths                     = local.paths
    personal_domain           = local.personal_domain
  }
  ...
  global_descriptions = {
    ...
    personal_domain           = "domain hosts personal website and receive email categorized by recipient"
  }
